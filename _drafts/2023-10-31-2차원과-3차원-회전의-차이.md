...
![그림1](/assets/img/posts/mathmatics/rotation/7-2차원과-3차원-회전의-차이/3d_axis_rotation_vector.png){: width="500" height="400"}
...
예시로 3차원 상에서 $x$축으로 $\theta$만큼 회전시키는 회전 행렬 $R$은 다음과 같다.
